...
public struct Label: UIViewRepresentable {
    ...
    public static func dismantleUIView(_ uiView: DAWNLabel, coordinator: ()) {
        uiView.subviews.forEach({ $0.removeFromSuperview() })
    }

    public func sizeThatFits(_ proposal: ProposedViewSize, uiView: DAWNLabel, context: Context)
        -> CGSize?
    {
